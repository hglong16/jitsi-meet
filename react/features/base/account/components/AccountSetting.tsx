  ...
  return (
    <Layout>
      <div className='account-setting-container ml-8'>
        ...
        <Tabs value={activeTab} onChange={handleSelectTab} sx={{ minHeight: '40px' }}>
          <Tab icon={<PersonIcon style={{ height: 20 }} />} iconPosition="start" label="Hồ sơ" />
          <Tab icon={<KeyIcon style={{ height: 20 }} />} iconPosition="start" label="Mật khẩu" />
        </Tabs>
        {
